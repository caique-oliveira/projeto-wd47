;(function(){
    ...
    window.adicionaCartaoMural = function adicionaCartaoMural(cartao0bj){
        numeroDoCartao++
        const conteudoDoCartao = cartao0bj.conteudo
        const cartao = $(`
        <article id="cartao_${numeroDoCartao}" class="cartao" tabindex="0" style="background-color:${cartao0bj.cor}">
...
$.ajax({
    url: "https://ceep.herokuapp.com/cartoes/carregar",method:"GET",
    data: {usuario: "seuemail@email.com.br"},
    dataType: "jsonp",
    success: function (objeto){
        const cartoes = objeto.cartoes
        cartoes.forEach(function(cartao){
            adicionaCartaoMural(cartao)
        })
    }
